...
void add_widget_with_label_hbox(GtkContainer *box, gchar *caption, GtkWidget *widget){
...
void add_widget_with_label_vbox(GtkContainer *box, gchar *caption, GtkWidget *widget){
  GtkWidget *label = gtk_label_new(caption);
...
void print_active(char *button_name, GtkToggleButton *button) {
  ...
  printf("%s is %s\n", button_name, active?"active":"notactive");
}
...
gint main (gint argc, gchar *argv[]) {
  ...
  add_widget_with_label_hbox(GTK_CONTAINER(vbox), "ToggleButton:", togglebutton);
  add_widget_with_label_hbox(GTK_CONTAINER(vbox), "CheckButton:", checkbutton);
  add_widget_with_label_hbox(GTK_CONTAINER(vbox), "Radio 1:", radiobutton1);
  add_widget_with_label_hbox(GTK_CONTAINER(vbox), "Radio 2:", radiobutton2);
  add_widget_with_label_hbox(GTK_CONTAINER(vbox), "Button:", button);
